...
import '../../HelperClasses/InitialPointOfAccount/BackGroundMoving.dart';
import '../../HelperClasses/Buttons.dart';
import '../../HelperClasses/InitialPointOfAccount/CheckAgreement.dart';
...
class _LogInSelectingOptionState extends State<LogInSelectingOption> {
  ...
  Future<void> _launchURLGoogle() async {
    const url = 'https://autoapp.elite-house.uz/loginGoogle/';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch';
        ...
        body: nextPage?
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Buttons(
                      ...
                      height: width,
                      onPressed: launcher(() {
                        Navigator.of(context).pushNamed("/select/registration");
                      }),
              ...
              Container(
                margin: EdgeInsets.fromLTRB(width * 0.27, 0, width * 0.27, 0),
                width: double.infinity,
                child: Column(
                  children: [
                    Text(
