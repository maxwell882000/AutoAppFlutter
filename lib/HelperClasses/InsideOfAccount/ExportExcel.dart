...
class ExportExcel {
 ...
 Future<String> export() async {
    ...
    sheet.appendRow(["Название транспорта",SingletonUserInformation().nameOfTransport]);
    sheet.appendRow(["Mарка",SingletonUserInformation().marka]);
    sheet.appendRow(["Модель",SingletonUserInformation().model]);
    sheet.appendRow(["Год производства",SingletonUserInformation().yearOfMade]);
    ...
    sheet.appendRow(["Расходы в этом месяце",SingletonUserInformation().expenses.in_this_month]);
    sheet.appendRow(["Расходы за все время",SingletonUserInformation().expenses.all_time]);
